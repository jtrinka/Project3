	...
	public Robin(){ 
		...
		JOptionPane.showMessageDialog(frame, "Therefore, your bird is a robin.");
		try{Thread.sleep(1500);}
		catch(Exception e){};
		
		//Delanie Chapman
		JFrame Robinframe = new JFrame("Robin");
		Robinframe.setSize(400,400);
		Robinframe.setLocation(400,400);
		JPanel panel = new JPanel();
		JLabel label = new JLabel(new ImageIcon("X:\\My Documents\\CS 110\\robin.jpg"));
		JLabel label1 = new JLabel("Robin");
		panel.add(label);
		panel.add(label1);
		Robinframe.add(panel);
		Robinframe.setVisible(true);
